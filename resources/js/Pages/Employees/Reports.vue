...
buttons1.value = [
    {
        ...
        className: 'inline-flex items-center px-4 py-2 bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-200 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150'
    }
]
        ...
        <div class="py-12">
            <div class="mx-auto sm:px-6 lg:px-8">
                ...
                <div v-if="report == '1'" class="px-6 py-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <DataTables :data="employees" :columns="columns1"
                ...
                <div v-else class="px-6 py-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <DataTables :data="departments" :columns="columns2"
                                class="w-full border border-gray-400"
                                :options="{responsive:true,autoWidth:false,dom:'Bfrtip',buttons:buttons1}">
                        <thead>
                        <tr class="bg-gray-100">
